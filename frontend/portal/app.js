...
const I18N = {
  en: {
    ...
    'reg.asha_heading': 'Community Health Worker registration',
    ...
    'reg.asha_submit': 'Create Community Health Worker account',
    ...
    'reg.msg_asha': 'Welcome, {0}! Your Community Health Worker account has been created. You can sign in now.',
  ...
  hi: {
    ...
    'role.asha': 'सामुदायिक स्वास्थ्य कार्यकर्ता',
    'role.doctor': 'डॉक्टर',
    'role.admin': 'प्रशासक',
    ...
    'reg.asha_heading': 'सामुदायिक स्वास्थ्य कार्यकर्ता पंजीकरण',
    ...
    'reg.asha_submit': 'सामुदायिक स्वास्थ्य कार्यकर्ता खाता बनाएँ',
    ...
    'reg.msg_asha': 'स्वागत है, {0}! आपका सामुदायिक स्वास्थ्य कार्यकर्ता खाता बन गया है। आप अभी साइन इन कर सकते हैं।',
  ...
  mr: {
    ...
    'role.asha': 'सामुदायिक आरोग्य कार्यकर्ता',
    'role.doctor': 'डॉक्टर',
    'role.admin': 'प्रशासक',
    ...
    'reg.asha_heading': 'सामुदायिक आरोग्य कार्यकर्ता नोंदणी',
    ...
    'reg.asha_submit': 'सामुदायिक आरोग्य कार्यकर्ता खाते तयार करा',
    ...
    'reg.msg_asha': 'स्वागत आहे, {0}! तुमचे सामुदायिक आरोग्य कार्यकर्ता खाते तयार झाले आहे. तुम्ही आता साइन इन करू शकता.',
  ...
  bn: {
    ...
    'role.asha': 'সামাজিক স্বাস্থ্যকর্মী',
    'role.doctor': 'ডাক্তার',
    'role.admin': 'প্রশাসক',
    ...
    'reg.asha_heading': 'সামাজিক স্বাস্থ্যকর্মী নিবন্ধন',
    ...
    'reg.asha_submit': 'সামাজিক স্বাস্থ্যকর্মী অ্যাকাউন্ট তৈরি করুন',
    ...
    'reg.msg_asha': 'স্বাগতম, {0}! আপনার সামাজিক স্বাস্থ্যকর্মী অ্যাকাউন্ট তৈরি হয়েছে। আপনি এখন সাইন ইন করতে পারেন।',
...
async function onLogin(e) {
  ...
  try {
    ...
    // Persist the signed-in session so the role portals can greet the user by
    // name (the CHW dashboard reads 'gramarogya_profile' on load).
    try {
      localStorage.setItem('gramarogya_profile', JSON.stringify({
        name: (res.user && res.user.name) || '',
        role: (res.user && res.user.role) || state.role,
        phone: (res.user && res.user.phone) || '',
        signedInAt: new Date().toISOString(),
      }));
    } catch (e) { /* storage unavailable — greeting simply stays hidden */ }
